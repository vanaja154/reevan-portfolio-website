  ...
  const blogPosts = [
    {
      ...
      date: "12 March 21",
      readTime: "5 Min Read",
      title: "Finding the best social media platform for your audience and business",
    },
    {
      id: 2,
          ...
          {blogPosts.map((post) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <h3 className="text-lg font-semibold text-gray-900 leading-snug hover:text-blue-600 cursor-pointer">
                  {post.title}
                </h3>
              </div>
            </div>
