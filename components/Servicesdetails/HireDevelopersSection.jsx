      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-6 md:px-12">
        ...
        <div className="max-w-xl text-left">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 leading-snug">
            Hire world-class <span className="underline decoration-orange-500">developers</span> for your project
          </h1>
          ...
          <div className="mt-8 flex items-center gap-4 flex-wrap">
            <button className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-full font-medium shadow-lg">
              Talk to our experts →
            </button>
