        ...
        <div className="bg-white rounded-2xl p-10 shadow-sm w-full">
          ...
          <form className="space-y-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <input type="text" placeholder="Full Name" className="border-b border-gray-300 focus:outline-none p-2 w-full" />
              <input type="email" placeholder="Email Address" className="border-b border-gray-300 focus:outline-none p-2 w-full" />
              <input type="text" placeholder="Contact Number" className="border-b border-gray-300 focus:outline-none p-2 w-full" />
              <input type="text" placeholder="Skype" className="border-b border-gray-300 focus:outline-none p-2 w-full" />
              <input type="text" placeholder="Subject" className="border-b border-gray-300 focus:outline-none p-2 w-full" />
        ...
        <div className="space-y-8 bg-white rounded-2xl p-10 shadow-sm w-full">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2">
                <FaWhatsapp /> +91 112 3345 5688
              </li>
              <li className="flex items-center gap-2">
                <FaEnvelope /> <span className="border-b border-orange-500">reevan@abc.com</span>
              </li>
              <li className="flex items-center gap-2">
                <FaSkype /> <span className="border-b border-orange-500">reevan.skype</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-sm flex items-center gap-2 mt-2 border-b border-orange-500 w-fit cursor-pointer">
